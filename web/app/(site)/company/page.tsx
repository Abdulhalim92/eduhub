        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 36, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 14, color: C.sub, lineHeight: 1.7 }}>
              {t({
                ru: "Фильтры по району, цене и программе обучения. Рейтинг по 9 объективным метрикам. Отзывы только от родителей с подтверждённой связью с учреждением. Прямой чат — без звонков и ожидания.",
                tg: "Филтрҳо аз рӯи ноҳия, нарх ва барномаи таълим. Рейтинг аз рӯи 9 меъёри объективӣ. Шарҳҳо танҳо аз волидайне, ки алоқаи тасдиқшуда доранд. Чати бевосита — бе занг ва интизорӣ.",
              })}
            </p>
          </div>
