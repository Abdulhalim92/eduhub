...
## Что это
EduHub Tajikistan — национальная платформа поиска, сравнения и оценки образовательных учреждений (сады, дошкольные центры, школы, центры допобразования, вузы). Трёхсторонний рынок: родители/студенты, учреждения, соискатели-педагоги (соискатели — вторая волна). MVP — старт в Душанбе с быстрым расширением на регионы Таджикистана (не ограничено одним городом архитектурно).

Источники истины:
- `EduHub_Technical_Specification.docx` — SRS: архитектура, стек, FR-01…FR-24, модель данных, NFR
- `EduHub_Business_Plan_Pro.docx` — бизнес-модель, рынок, роадмап, KPI
